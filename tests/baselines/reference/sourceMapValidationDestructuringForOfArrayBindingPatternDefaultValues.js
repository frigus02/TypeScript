...
for (var _i = 0, robots_1 = robots; _i < robots_1.length; _i++) {
    var _a = robots_1[_i], _b = _a[1], nameA_1 = _b === void 0 ? "noName" : _b;
    console.log(nameA_1);
}
for (var _c = 0, _d = getRobots(); _c < _d.length; _c++) {
    var _e = _d[_c], _f = _e[1], nameA_2 = _f === void 0 ? "noName" : _f;
    console.log(nameA_2);
}
for (var _g = 0, _h = [robotA, robotB]; _g < _h.length; _g++) {
    var _j = _h[_g], _k = _j[1], nameA_3 = _k === void 0 ? "noName" : _k;
    console.log(nameA_3);
}
for (var _l = 0, multiRobots_1 = multiRobots; _l < multiRobots_1.length; _l++) {
    var _m = multiRobots_1[_l], _o = _m[1], _p = _o === void 0 ? ["skill1", "skill2"] : _o, _q = _p[0], primarySkillA_1 = _q === void 0 ? "primary" : _q, _r = _p[1], secondarySkillA_1 = _r === void 0 ? "secondary" : _r;
    console.log(primarySkillA_1);
}
for (var _s = 0, _t = getMultiRobots(); _s < _t.length; _s++) {
    var _u = _t[_s], _v = _u[1], _w = _v === void 0 ? ["skill1", "skill2"] : _v, _x = _w[0], primarySkillA_2 = _x === void 0 ? "primary" : _x, _y = _w[1], secondarySkillA_2 = _y === void 0 ? "secondary" : _y;
    console.log(primarySkillA_2);
}
for (var _z = 0, _0 = [multiRobotA, multiRobotB]; _z < _0.length; _z++) {
    var _1 = _0[_z], _2 = _1[1], _3 = _2 === void 0 ? ["skill1", "skill2"] : _2, _4 = _3[0], primarySkillA_3 = _4 === void 0 ? "primary" : _4, _5 = _3[1], secondarySkillA_3 = _5 === void 0 ? "secondary" : _5;
    console.log(primarySkillA_3);
}
for (var _6 = 0, robots_2 = robots; _6 < robots_2.length; _6++) {
    var _7 = robots_2[_6][0], numberB_1 = _7 === void 0 ? -1 : _7;
    console.log(numberB_1);
}
for (var _8 = 0, _9 = getRobots(); _8 < _9.length; _8++) {
    var _10 = _9[_8][0], numberB_2 = _10 === void 0 ? -1 : _10;
    console.log(numberB_2);
}
for (var _11 = 0, _12 = [robotA, robotB]; _11 < _12.length; _11++) {
    var _13 = _12[_11][0], numberB_3 = _13 === void 0 ? -1 : _13;
    console.log(numberB_3);
}
for (var _14 = 0, multiRobots_2 = multiRobots; _14 < multiRobots_2.length; _14++) {
    var _15 = multiRobots_2[_14][0], nameB_1 = _15 === void 0 ? "noName" : _15;
    console.log(nameB_1);
}
for (var _16 = 0, _17 = getMultiRobots(); _16 < _17.length; _16++) {
    var _18 = _17[_16][0], nameB_2 = _18 === void 0 ? "noName" : _18;
    console.log(nameB_2);
}
for (var _19 = 0, _20 = [multiRobotA, multiRobotB]; _19 < _20.length; _19++) {
    var _21 = _20[_19][0], nameB_3 = _21 === void 0 ? "noName" : _21;
    console.log(nameB_3);
}
for (var _22 = 0, robots_3 = robots; _22 < robots_3.length; _22++) {
    var _23 = robots_3[_22], _24 = _23[0], numberA2_1 = _24 === void 0 ? -1 : _24, _25 = _23[1], nameA2_1 = _25 === void 0 ? "noName" : _25, _26 = _23[2], skillA2_1 = _26 === void 0 ? "skill" : _26;
    console.log(nameA2_1);
}
for (var _27 = 0, _28 = getRobots(); _27 < _28.length; _27++) {
    var _29 = _28[_27], _30 = _29[0], numberA2_2 = _30 === void 0 ? -1 : _30, _31 = _29[1], nameA2_2 = _31 === void 0 ? "noName" : _31, _32 = _29[2], skillA2_2 = _32 === void 0 ? "skill" : _32;
    console.log(nameA2_2);
}
for (var _33 = 0, _34 = [robotA, robotB]; _33 < _34.length; _33++) {
    var _35 = _34[_33], _36 = _35[0], numberA2_3 = _36 === void 0 ? -1 : _36, _37 = _35[1], nameA2_3 = _37 === void 0 ? "noName" : _37, _38 = _35[2], skillA2_3 = _38 === void 0 ? "skill" : _38;
    console.log(nameA2_3);
}
for (var _39 = 0, multiRobots_3 = multiRobots; _39 < multiRobots_3.length; _39++) {
    var _40 = multiRobots_3[_39], _41 = _40[0], nameMA_1 = _41 === void 0 ? "noName" : _41, _42 = _40[1], _43 = _42 === void 0 ? ["skill1", "skill2"] : _42, _44 = _43[0], primarySkillA_4 = _44 === void 0 ? "primary" : _44, _45 = _43[1], secondarySkillA_4 = _45 === void 0 ? "secondary" : _45;
    console.log(nameMA_1);
}
for (var _46 = 0, _47 = getMultiRobots(); _46 < _47.length; _46++) {
    var _48 = _47[_46], _49 = _48[0], nameMA_2 = _49 === void 0 ? "noName" : _49, _50 = _48[1], _51 = _50 === void 0 ? ["skill1", "skill2"] : _50, _52 = _51[0], primarySkillA_5 = _52 === void 0 ? "primary" : _52, _53 = _51[1], secondarySkillA_5 = _53 === void 0 ? "secondary" : _53;
    console.log(nameMA_2);
}
for (var _54 = 0, _55 = [multiRobotA, multiRobotB]; _54 < _55.length; _54++) {
    var _56 = _55[_54], _57 = _56[0], nameMA_3 = _57 === void 0 ? "noName" : _57, _58 = _56[1], _59 = _58 === void 0 ? ["skill1", "skill2"] : _58, _60 = _59[0], primarySkillA_6 = _60 === void 0 ? "primary" : _60, _61 = _59[1], secondarySkillA_6 = _61 === void 0 ? "secondary" : _61;
    console.log(nameMA_3);
}
for (var _62 = 0, robots_4 = robots; _62 < robots_4.length; _62++) {
    var _63 = robots_4[_62], _64 = _63[0], numberA3_1 = _64 === void 0 ? -1 : _64, robotAInfo_1 = _63.slice(1);
    console.log(numberA3_1);
}
for (var _65 = 0, _66 = getRobots(); _65 < _66.length; _65++) {
    var _67 = _66[_65], _68 = _67[0], numberA3_2 = _68 === void 0 ? -1 : _68, robotAInfo_2 = _67.slice(1);
    console.log(numberA3_2);
}
for (var _69 = 0, _70 = [robotA, robotB]; _69 < _70.length; _69++) {
    var _71 = _70[_69], _72 = _71[0], numberA3_3 = _72 === void 0 ? -1 : _72, robotAInfo_3 = _71.slice(1);
