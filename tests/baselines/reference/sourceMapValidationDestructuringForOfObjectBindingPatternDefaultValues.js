...
for (var _i = 0, robots_1 = robots; _i < robots_1.length; _i++) {
    var _a = robots_1[_i].name, nameA_1 = _a === void 0 ? "noName" : _a;
    console.log(nameA_1);
}
for (var _b = 0, _c = getRobots(); _b < _c.length; _b++) {
    var _d = _c[_b].name, nameA_2 = _d === void 0 ? "noName" : _d;
    console.log(nameA_2);
}
for (var _e = 0, _f = [{ name: "mower", skill: "mowing" }, { name: "trimmer", skill: "trimming" }]; _e < _f.length; _e++) {
    var _g = _f[_e].name, nameA_3 = _g === void 0 ? "noName" : _g;
    console.log(nameA_3);
}
for (var _h = 0, multiRobots_1 = multiRobots; _h < multiRobots_1.length; _h++) {
    var _j = multiRobots_1[_h].skills, _k = _j === void 0 ? { primary: "nosKill", secondary: "noSkill" } : _j, _l = _k.primary, primaryA_1 = _l === void 0 ? "primary" : _l, _m = _k.secondary, secondaryA_1 = _m === void 0 ? "secondary" : _m;
    console.log(primaryA_1);
}
for (var _o = 0, _p = getMultiRobots(); _o < _p.length; _o++) {
    var _q = _p[_o].skills, _r = _q === void 0 ? { primary: "nosKill", secondary: "noSkill" } : _q, _s = _r.primary, primaryA_2 = _s === void 0 ? "primary" : _s, _t = _r.secondary, secondaryA_2 = _t === void 0 ? "secondary" : _t;
...
for (var _u = 0, _v = [{ name: "mower", skills: { primary: "mowing", secondary: "none" } },
    ...
    var _w = _v[_u].skills, _x = _w === void 0 ? { primary: "nosKill", secondary: "noSkill" } : _w, _y = _x.primary, primaryA_3 = _y === void 0 ? "primary" : _y, _z = _x.secondary, secondaryA_3 = _z === void 0 ? "secondary" : _z;
    console.log(primaryA_3);
}
for (var _0 = 0, robots_2 = robots; _0 < robots_2.length; _0++) {
    var _1 = robots_2[_0], _2 = _1.name, nameA_4 = _2 === void 0 ? "noName" : _2, _3 = _1.skill, skillA_1 = _3 === void 0 ? "noSkill" : _3;
    console.log(nameA_4);
}
for (var _4 = 0, _5 = getRobots(); _4 < _5.length; _4++) {
    var _6 = _5[_4], _7 = _6.name, nameA_5 = _7 === void 0 ? "noName" : _7, _8 = _6.skill, skillA_2 = _8 === void 0 ? "noSkill" : _8;
    console.log(nameA_5);
}
for (var _9 = 0, _10 = [{ name: "mower", skill: "mowing" }, { name: "trimmer", skill: "trimming" }]; _9 < _10.length; _9++) {
    var _11 = _10[_9], _12 = _11.name, nameA_6 = _12 === void 0 ? "noName" : _12, _13 = _11.skill, skillA_3 = _13 === void 0 ? "noSkill" : _13;
    console.log(nameA_6);
}
for (var _14 = 0, multiRobots_2 = multiRobots; _14 < multiRobots_2.length; _14++) {
    var _15 = multiRobots_2[_14], _16 = _15.name, nameA_7 = _16 === void 0 ? "noName" : _16, _17 = _15.skills, _18 = _17 === void 0 ? { primary: "noSkill", secondary: "noSkill" } : _17, _19 = _18.primary, primaryA_4 = _19 === void 0 ? "primary" : _19, _20 = _18.secondary, secondaryA_4 = _20 === void 0 ? "secondary" : _20;
    console.log(nameA_7);
}
for (var _21 = 0, _22 = getMultiRobots(); _21 < _22.length; _21++) {
    var _23 = _22[_21], _24 = _23.name, nameA_8 = _24 === void 0 ? "noName" : _24, _25 = _23.skills, _26 = _25 === void 0 ? { primary: "noSkill", secondary: "noSkill" } : _25, _27 = _26.primary, primaryA_5 = _27 === void 0 ? "primary" : _27, _28 = _26.secondary, secondaryA_5 = _28 === void 0 ? "secondary" : _28;
    console.log(nameA_8);
}
for (var _29 = 0, _30 = [{ name: "mower", skills: { primary: "mowing", secondary: "none" } },
    ...
    var _31 = _30[_29], _32 = _31.name, nameA_9 = _32 === void 0 ? "noName" : _32, _33 = _31.skills, _34 = _33 === void 0 ? { primary: "noSkill", secondary: "noSkill" } : _33, _35 = _34.primary, primaryA_6 = _35 === void 0 ? "primary" : _35, _36 = _34.secondary, secondaryA_6 = _36 === void 0 ? "secondary" : _36;
    console.log(nameA_9);
}
