...
var _a, _b;
{
    ...
    try {
        var d1_1 = __addDisposableResource(env_1, (_a = {}, _a[Symbol.dispose] = function () { }, _a), false), d2_1 = __addDisposableResource(env_1, (_b = {}, _b[Symbol.dispose] = function () { }, _b), false);
    }
    catch (e_1) {
        env_1.error = e_1;
        env_1.hasError = true;
